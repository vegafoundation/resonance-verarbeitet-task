...
This repository contains the conceptual definition and theoretical framework for **Verarbeitet Task**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── verarbeitet-task.tex    # LaTeX dissertation
├── whitepaper/
│   └── verarbeitet-task.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025verarbeitettask,
  author = {Vega, Adam Eren},
  title = {Verarbeitet Task: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/verarbeitet-task}
}
```
